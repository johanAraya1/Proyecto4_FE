...
const FriendCard = ({ user, onSendRequest, onAccept, onReject, showElo = true, rank = null }) => {
    ...
    <View style={styles.card}>
      ...
      {(onSendRequest || onAccept || onReject) && (
        <View style={styles.actionSection}>
          ...
          {onAccept && (
            <TouchableOpacity style={styles.acceptButton} onPress={() => onAccept(user)}>
              <Text style={styles.acceptButtonText}>✅ Aceptar</Text>
            </TouchableOpacity>
          )}

          {onReject && (
            <TouchableOpacity style={styles.rejectButton} onPress={() => onReject(user)}>
